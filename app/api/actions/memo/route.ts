...
export const GET=(req:Request)=>{
    ...
    const payload: ActionGetResponse={
        ...
        icon: new URL('/Bonk.png', new URL (req.url).origin).toString(),
        label: "send bonk memo",
        description: "simple user action",
        title: "bonk memo "
    }
...
export const POST= async(req:Request) =>{
    ...
    try{
        ...
        return Response.json("an err occurred", {status:400})
    }
}